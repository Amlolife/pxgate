...
![pxgate Screenshot](./.github/assets/vibeculling_main.png)
...
2.  This project was originally named "PhotoSort"(https://github.com/newboon/PhotoSort) and later VibeCulling and was tested with feedback from a few Korean camera users. It has been rebranded as pxgate by Amlolife.
...
You can download the latest version for Windows and macOS from the **GitHub Releases page**.

-   **Windows:** Download the `pxgate_vX.X.X_win.zip` file.
-   Extract the zip
-   Run `pxgate.exe` (no installation needed)
-   **macOS:** Download the `pxgate_vX.X.X_macOS.dmg.zip` file.
